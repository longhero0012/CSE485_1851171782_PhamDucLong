            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="tb-contact">
                        <p><i class="fas fa-envelope"></i>đại học thủy lợi-TLU</p>
            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="social ml-auto">
                        ...
                        <a href="https://www.facebook.com/daihocthuyloi1959"><i class="fab fa-facebook-f"></i></a>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        <h3 class="title">Nghiên cứu</h3>
                        <ul>
                            <li><a href="#">Các đề tài dự áo</a></li>
            ...
            <div class="row">
                <div class="col-md-6 copyright">
                    <ul>
                        ...
                        <p> Điện thoại: (+84)-024 3 5632211. Email: vpkcntt@tlu.edu.vn</a></p>
